                ...
                <div className="row justify-content-center">
                    <div className="col-lg-8 col-md-12">
                        <div className="it-testimonial-title-box text-center mb-70">
                            <span className="tp-section-subtitle-platform platform-text-black mb-20 tp-split-text tp-split-right">Geri Bildirimler</span>
                            <h4 className="tp-section-title-platform platform-text-black mb-20 tp-split-text tp-split-right">{"Büyüyen KOBİ'lerin Güvendiği Ücretsiz ERP."}</h4>
                        </div>
                    </div>
                </div>
                <div className="row justify-content-center">
                                                    ...
                                                    <div className="it-testimonial-thumb">
                                                        {testimonial.avatar && (
                                                            <Image
                                                                ...
                                                                alt={testimonial.name || "yorum"}
                                                                width={512}
                                                                height={512}
                                                                quality={75}
                                                                sizes="242px"
                                                                style={{ width: 242, height: 242, objectFit: 'cover', borderRadius: '50%' }}
                                                            />
                                                        )}
                                                    </div>
                                                </div>
