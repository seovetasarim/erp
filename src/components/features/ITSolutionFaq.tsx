...
type ITSolutionFeatureProps = {
    showTitle?: boolean;
    sectionId?: string;
    compact?: boolean;
};

const ITSolutionFeature = ({ showTitle = true, sectionId = "ozellikler", compact = false }: ITSolutionFeatureProps) => {

    return (
        <div
            className={`it-feature-area z-index-2 p-relative pb-55 ${compact ? "it-feature-ptb-compact" : "it-feature-ptb"}`}
        ...
        >
            ...
            <div className="container container-1460">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-12">
                            <div className="it-feature-title-box text-center mb-70">
                                <span className="tp-section-subtitle-platform platform-text-black tp-split-text tp-split-right">Temel Modüller</span>
                                <h4 className="tp-section-title-platform platform-text-black fs-200 tp-split-text tp-split-right it-feature-main-title">Özellikler</h4>
                            </div>
                        </div>
                    </div>
                )}
                {!showTitle && (
                    <div className="row justify-content-center">
                        <div className="col-12">
                            <div className="it-feature-title-box text-center mb-60">
                                <span className="tp-section-subtitle-platform platform-text-black tp-split-text tp-split-right">Temel Modüller</span>
                                <h4 className="tp-section-title-platform platform-text-black fs-84 tp-split-text tp-split-right">Beş güçlü araç, bir ERP</h4>
                            </div>
                        </div>
                    </div>
                )}
                            ...
                            <div className="it-feature-item text-center tp_fade_ainm">
                                ...
                                <div className={`it-feature-icon ${feature.colorClass}`}>
                                    {feature.svgIcon ? (
                                        ...
                                        feature.image && (
                                            <Image style={{ width: "auto", height: "auto" }} src={feature.image} alt={`icon-${feature.id}`} />
                                        )
                                    )}
                                </div>
