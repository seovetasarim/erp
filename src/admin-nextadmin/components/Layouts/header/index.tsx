...
import { SearchIcon } from "@na/assets/icons";
...
export function Header() {
  ...
  return (
    <header className="border-stroke shadow-1 dark:border-stroke-dark dark:bg-gray-dark sticky top-0 z-30 flex items-center justify-between border-b bg-white px-4 py-5 md:px-5 2xl:px-10">
      ...
      {isMobile && (
        <div className="2xsm:ml-4 ml-2 max-[430px]:hidden">
          <DijitalErpLogo href="/admin" variant="dark" size="sm" className="dark:hidden" />
          <DijitalErpLogo
            href="/admin"
            variant="light"
            size="sm"
      ...
      <div className="max-xl:hidden">
        ...
        <p className="text-sm font-medium text-dark-5 dark:text-dark-6">DijitalERP</p>
      </div>
