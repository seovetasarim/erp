...
import { useIsMobile } from "@na/hooks/use-mobile";
...
const notificationList = [
  {
    image: "/admin-nextadmin/images/user/user-15.png",
    title: "Piter Joined the Team!",
    subTitle: "Congratulate him",
  },
  {
    image: "/admin-nextadmin/images/user/user-03.png",
    title: "New message",
    subTitle: "Devid sent a new message",
  },
  {
    image: "/admin-nextadmin/images/user/user-26.png",
    title: "New Payment received",
    subTitle: "Check your earnings",
  },
  {
    image: "/admin-nextadmin/images/user/user-28.png",
    title: "Jolly completed tasks",
    subTitle: "Assign new task",
  },
  {
    image: "/admin-nextadmin/images/user/user-27.png",
