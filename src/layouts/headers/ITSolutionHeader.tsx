  ...
  return (
    <>
      <header>
        <div
          id="header-sticky"
          className={`tp-header-10-area tp-header-11-style tp-header-blur sticky-white-bg header-transparent${
            isSticky ? " header-sticky" : ""
          }${openOffCanvas ? " is-offcanvas-open" : ""}`}
        >
                    ...
                    <div className="tp-header-10-right d-flex align-items-center">
                      ...
                      <div className="tp-header-11-search-box d-none d-md-block">
                        <button
                          ...
                          className="tp-header-11-search tp-search-open-btn"
                          type="button"
                          aria-label="Ara"
                        >
                          <span>
