export default function SeoContentSection() {
  return (
    <section className="section section-seo" aria-labelledby="seo-isletme-heading">
      <div className="section-inner">
        <h2 id="seo-isletme-heading" className="seo-main-title">
          İşletme Yönetim Sistemi ile KOBİ Yönetimi
        </h2>
        <div className="seo-columns">
          <article className="seo-col">
            <h3>İşletme Yönetim Sistemi Nedir?</h3>
            <p>
            ...
            <p>
              <strong>İşletme yönetim sistemi</strong> perakende, toptan satış, üretim, lojistik ve hizmet sektörü için idealdir. <strong>KOBİ işletme yazılımı</strong> olarak DijitalERP, 1–50 çalışan arası işletmelerin operasyonlarını dijitalleştirmesine yardımcı olur. <strong>ERP</strong> ve <strong>işletme yönetimi</strong> tek yazılımda.
            </p>
          </article>
          <article className="seo-col">
