...
export const metadata: Metadata = {
  ...
  description: 'Toptan satış yazılımı: Stok takip, cari yönetim, satış faturası, E-Fatura ve raporlar. Toptancılar için offline çalışan ERP programı. 25.000 TL\'den başlar.',
