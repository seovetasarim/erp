...
export const metadata: Metadata = {
  ...
  description: 'Profesyonel stok takip yazılımı. Barkod okuyucu, stok sayım, minimum stok uyarısı, Excel export. Offline çalışan stok takip programı. 25.000 TL\'den başlar.',
