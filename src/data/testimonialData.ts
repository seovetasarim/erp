...
import avatarAhmet from '../../public/assets/img/home-11/testimonial/user-ahmet.png';
import avatarSelin from '../../public/assets/img/home-11/testimonial/user-selin.png';
import avatarMurat from '../../public/assets/img/home-11/testimonial/user-murat.png';
import avatarAyse from '../../public/assets/img/home-11/testimonial/user-ayse.png';
import avatarEmre from '../../public/assets/img/home-11/testimonial/user-emre.png';
...
const testimonialsData: TestimonialDT[] = [
    ...
    //Home IT Solution testimonial data start
    {
        ...
        quote: "DijitalERP ile offline stok takip çok kolay. İnternet kesilse bile cari ve fatura işlemlerimiz aksamıyor.",
        name: "Ahmet Y."
    },
    {
        id: 34,
        avatar: avatarSelin,
        brandLogo: testiBrand,
        quote: "Ücretsiz ERP arıyorduk; cari yönetim ve kasa modülü sayesinde günlük işlerimiz hızlandı.",
        name: "Selin K."
    },
    {
        id: 35,
        avatar: avatarMurat,
        brandLogo: testiBrand,
        quote: "Fatura yazılımı sade ve hızlı. KOBİ ERP ihtiyacımız için DijitalERP tam isabet oldu.",
        name: "Murat T."
    },
    {
        id: 36,
        avatar: avatarAyse,
        brandLogo: testiBrand,
        quote: "Stok ve cari raporları net. Offline Windows ERP olması bizim için en büyük avantaj.",
        name: "Ayşe D."
    },
    {
        id: 37,
        avatar: avatarEmre,
        brandLogo: testiBrand,
        quote: "Kurulumu kolay, ücretsiz indirdik. Depo ve satış süreçlerimizi tek programda topladık.",
        name: "Emre B."
    },
    //Home IT Solution testimonial data end
    {
        id: 38,
