...
const servicesData: servicesDT[] = [
    ...
    //home twelve IT Solution feature data start
    {
        ...
        title: "Stok Takip",
        image: icon1,
        svgIcon: StockFeatureIcon,
        description: "Offline stok takip ile depo, ürün ve stok hareketlerinizi anlık ve güvenle yönetin.",
        categories: ["Stok", "Depo", "Ürün"],
        colorClass: "color-1",
        delay: ".3",
        link: "/downloads/dijitalerp.rar",
    },
    {
        id: 29,
        title: "Cari Yönetim",
        image: icon2,
        svgIcon: CariFeatureIcon,
        description: "Müşteri ve tedarikçi cari hesaplarını tek ekrandan takip edin; tahsilatları kaçırmayın.",
        categories: ["Cari", "Tahsilat", "Borç"],
        colorClass: "color-2",
        delay: ".5",
        link: "/downloads/dijitalerp.rar",
    },
    {
        ...
        image: icon3,
        svgIcon: InvoiceFeatureIcon,
        description: "Hızlı fatura yazılımı ile satış ve alış belgelerini saniyeler içinde oluşturun.",
        categories: ["Fatura", "Belge", "Satış"],
        colorClass: "color-3",
        delay: ".7",
        link: "/downloads/dijitalerp.rar",
    },
    {
        ...
        title: "Kasa Modülü",
        image: icon4,
        svgIcon: CashFeatureIcon,
        description: "Nakit ve banka hareketlerini kaydedin; kasa durumunu gün boyu net görün.",
        categories: ["Kasa", "Nakit", "Banka"],
        colorClass: "color-4",
        delay: ".3",
        link: "/downloads/dijitalerp.rar",
    },
    {
        ...
        title: "Raporlama",
        image: icon5,
        svgIcon: ReportFeatureIcon,
        description: "KOBİ ERP raporlarıyla stok, cari ve satış performansınızı tek bakışta izleyin.",
        categories: ["Rapor", "Analiz", "KOBİ"],
        colorClass: "color-5",
        delay: ".5",
        link: "/downloads/dijitalerp.rar",
    },
